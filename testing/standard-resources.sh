...
RUN_CHECK_CLIENT nodeset-create --owner lincolnb --node_number -1 --app_type generic --app_role worker-nodes --displayname="Node size for nersc-cori (Haswell partition)" --cores 32 --memory_mb 4000 --storage_mb 10000 --native_os "suse:v12" nersc-cori-nodesize
...
RUN_CHECK_CLIENT nodeset-create --owner lincolnb --node_number -1 --app_type generic --app_role worker-nodes --displayname="Node size for tacc-stampede2 (SKX partition)" --cores 96 --memory_mb 2000 --storage_mb 10000 --native_os "centos:v7.4" tacc-stampede2-nodesize
...
RUN_CHECK_CLIENT nodeset-create --owner btovar --node_number -1 --app_type generic --app_role worker-nodes --displayname="Node size for ndccl" --cores 4 --memory_mb 1000 --storage_mb 10000 --native_os "redhat:v7" ndccl-nodesize
...
RUN_CHECK_CLIENT nodeset-create --owner btovar --node_number -1 --app_type generic --app_role worker-nodes --displayname="Node size for ucla-hoffman2" --cores 8 --memory_mb 1000 --storage_mb 10000 --native_os "centos:v6.9" ucla-hoffman2-nodesize
...
RUN_CHECK_CLIENT nodeset-create --owner btovar --node_number -1 --app_type generic --app_role worker-nodes --displayname="Node size for psc-bridges (RMS partition)" --cores 28 --memory_mb 4000 --storage_mb 35000 --native_os "centos:v7.3" psc-bridges-nodesize
