...
RUN_CHECK_CLIENT nodeinfo-create --owner btovar  --displayname="Node size for ndccl" --cores 4 --memory_mb 4400 --storage_mb 35000 --native_os "redhat:v7" --features singularity ndccl-nodesize
