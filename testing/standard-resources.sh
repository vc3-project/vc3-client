...
RUN_CHECK_CLIENT nodeinfo-create --owner khurtado  --displayname="Node size for bluewaters-ncsa" --cores 4 --memory_mb 8000 --storage_mb 10000 --native_os "suse:v12" --features shifter bluewaters-ncsa-nodesize
