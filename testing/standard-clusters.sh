...
RUN_CHECK_CLIENT nodeset-create --owner btovar --node_number 0 --app_type htcondor --app_role worker-nodes --displayname="htcondor" btovar-htcondor-nodeset --public
...
RUN_CHECK_CLIENT nodeset-create --owner btovar --node_number 0 --app_type spark --app_role worker-nodes --displayname="spark" btovar-spark-nodeset --public
...
RUN_CHECK_CLIENT nodeset-create --owner btovar --node_number 0 --app_type workqueue --app_role worker-nodes --displayname="workqueue" btovar-workqueue-nodeset --public
...
RUN_CHECK_CLIENT nodeset-create --owner btovar --node_number 0 --app_type jupyter --app_role worker-nodes --displayname="jupyter" btovar-jupyter-nodeset --public
